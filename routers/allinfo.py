...
@router.post("/update/")
def update_all_info(update: UpdateAllInfo, username: Annotated[str, Depends(get_current_username)]):
...
def add_document(doc: AddDocument, username: Annotated[str, Depends(get_current_username)]):
